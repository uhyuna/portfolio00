// <![CDATA[
    if (matchMedia("screen and (min-width: 1439px)").matches) {
    var colours = new Array("#FFCCE0", "#FF96BE", "#FFEB8F", "#B6E2DB", "#55D6C2", "#f9c"); // colours of the hearts
    ...
    function set_width() {
    // Check if the window width is greater than 1439px
